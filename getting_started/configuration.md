...
В разделе описана конфигурация сервисов и ключевых
...
* в файле docker-compose.yml в блоке enviroment сервиса.
...
> Если значение переменной (в том числе значение по умолчанию)
